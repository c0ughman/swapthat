  ...
  return (
    <section className="relative flex h-[calc(100vh+140px)] flex-col overflow-hidden bg-blue pt-[calc(5rem+10px)] pb-[clamp(5.5rem,24vw,8rem)] md:h-screen md:pb-8 lg:pb-10">
      ...
      >
        ...
        <div className="relative z-10 flex h-full min-h-[min(100%,28rem)] items-end px-6 py-8 max-md:pb-[calc(1.5rem+80px)] sm:px-8 md:items-center md:min-h-0 md:px-14 lg:px-16">
