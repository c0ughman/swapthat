...
/**
 * Maps 0→1 from when the section top hits the viewport bottom to when the section bottom
 * hits the viewport bottom — so progress === 1 exactly when bottom of viewport touches bottom of section.
 */
function useProblemSectionHeadlineProgress(sectionRef: RefObject<HTMLElement | null>) {
  ...
  useEffect(() => {
    const update = () => {
      ...
      /* 2× faster: full headline completes in half the scroll range */
...
function ProblemSection() {
  ...
  return (
    <div className="relative w-full pb-32 sm:pb-36 md:pb-40 lg:pb-44 xl:pb-48 2xl:pb-52">
      ...
      {/* Same type scale as problem section h2; black; responsive inset so it clears the coral arc */}
      <p
...
/** Full-width curve between white above and the dark band — convex bulge into the dark area. */
...
/** Mirror of the top curve — dark band above, white below. */
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <AnimatedSection delay={0.1} direction="left" light>
            <div className="relative overflow-visible rounded-3xl border border-white/10 bg-white/5 p-8">
              {/* Bottom-right sticker — same treatment as ServiceCardCornerOverlays, scaled via MKT_X_STICKER_* */}
              <div
