...
// ─────────────────────────────────────────────────────────────────────────────
// All colors reference the brand tokens defined in globals.css — the single
// source of truth. Order: cool primary, warm primary, neutral, green accent, yellow.
const CARD_COLORS = [
  "var(--blue)",   // celestito
  "var(--coral)",  // naranjita
  "var(--beige-dark)",
...
// ─────────────────────────────────────────────────────────────────────────────
// ⚠️ MISSING / PLACEHOLDER: these three testimonials are invented. Swap for real,
// verified quotes (with name, role, sector, and ideally a real photo) before launch.
// Also update CHARLA_TESTIMONIALS_SHORT below to match.
